/**
  **************************************************************************
  * @file     at32f403_debug.h
  * @version  v2.0.3
  * @date     2022-06-28
  * @brief    at32f403 debug header file
  **************************************************************************
...
#ifndef __AT32F403_DEBUG_H
#define __AT32F403_DEBUG_H
...
#define DEBUG_TMR15_PAUSE                0x00400000 /*!< debug timer14 pause */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t reserved3            : 2;/* [24:23] */
