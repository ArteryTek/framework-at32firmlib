...
/**
  ...
  *         this parameter can be one of the following values:
  *         - SPI1_MUX_01                   - SPI1_MUX_10                   - I2C1_MUX                     - USART1_MUX
  *         - USART2_MUX                    - USART3_MUX_01                 - USART3_MUX_11                - TMR1_MUX_01
  *         - TMR1_MUX_11                   - TMR2_MUX_01                   - TMR2_MUX_10                  - TMR2_MUX_11
  *         - TMR3_MUX_10                   - TMR3_MUX_11                   - TMR4_MUX                     - CAN_MUX_10
  *         - CAN_MUX_11                    - PD01_MUX                      - TMR5CH4_MUX                  - ADC1_EXTRGPRE_MUX
  *         - ADC1_EXTRGORD_MUX             - ADC2_EXTRGPRE_MUX             - ADC2_EXTRGORD_MUX            - SWJTAG_MUX_001
  *         - SWJTAG_MUX_010                - SWJTAG_MUX_100
  *         - TMR15_MUX                     - TMR9_MUX                      - TMR10_MUX                    - TMR11_MUX
  *         - TMR13_MUX                     - TMR14_MUX                     - XMC_NADV_MUX                 - SPI4_MUX
...
void gpio_pin_remap_config(uint32_t gpio_remap, confirm_state new_state)
{
  ...
  /* clear remap value */
  if((gpio_remap == SPI1_MUX_01) || (gpio_remap == SPI1_MUX_10))
  {
    IOMUX->remap_bit.spi1_mux_h = FALSE;
    IOMUX->remap_bit.spi1_mux_l = FALSE;
  }
  else
  {
    *(uint32_t*)reg_addr &= ~remap_mask;
